...
for i in range(len(ranges)):
	model_ask = ensemble.RandomForestRegressor(n_estimators=100,
		criterion='mse',
		max_depth=None,
		min_samples_split=2, 
		min_samples_leaf=1, 
	...
	model_bid = ensemble.RandomForestRegressor(n_estimators=100,
		criterion='mse',
		max_depth=None,
		min_samples_split=2, 
		min_samples_leaf=1, 
...
with open('../run_models/RF_timeslots.model', 'wb') as output:
...
prediction.to_csv('../predictions/RF_timeslots.csv')
