#A simple Random Forest Regressor model which analzes seller 
...
print "Training..."
RF_model_seller = ensemble.RandomForestRegressor(n_estimators=200,
	criterion='mse',
	max_depth=None,
	min_samples_split=2, 
	min_samples_leaf=1, 
	...
	verbose=1, 
	warm_start=False)
RF_model_seller.fit(trainX_seller, trainY_seller)

RF_model_buyer = ensemble.RandomForestRegressor(n_estimators=200,
	criterion='mse',
	max_depth=None,
	min_samples_split=2, 
	min_samples_leaf=1, 
	...
	verbose=1, 
	warm_start=False)
RF_model_buyer.fit(trainX_buyer, trainY_buyer)

models = {'seller': RF_model_seller, 'buyer': RF_model_buyer}

with open('../run_models/RF_SB.model', 'wb') as output:
	pickle.dump(models, output, -1)

print "Predicting..."
testY_seller = RF_model_seller.predict(testX_seller)
testY_buyer = RF_model_buyer.predict(testX_buyer)
...
prediction.to_csv('../predictions/RF_SB.csv')
